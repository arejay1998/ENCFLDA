function [union_miRNA,L_in_ml,D_in_md,new_ml,new_md,new_ld,new_ml_association,new_md_association,new_ld_association]=get_new_association
    ...
    [~,ml]=xlsread('C:/Users/55307/Desktop/work/Copy_of_SMNBC/data/miRNA_lncRNA.xlsx');
    [~,md]=xlsread('C:/Users/55307/Desktop/work/Copy_of_SMNBC/data/miRNA_disease.xlsx');
    [~,ld]=xlsread('C:/Users/55307/Desktop/work/Copy_of_SMNBC/data/lncRNA_disease1.xlsx');
    L_in_ml = unique(ml(:,2));
    D_in_md  = unique(md(:,2));
