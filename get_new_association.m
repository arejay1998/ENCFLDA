function [union_miRNA,L_in_ml,D_in_md,new_ml,new_md,new_ld,new_ml_association,new_md_association,new_ld_association]=get_new_association
    ...
    [~,ml]=xlsread('C:/Users/AreJay/Desktop/LM-FP/data/miRNA_lncRNA.xlsx');
    [~,md]=xlsread('C:/Users/AreJay/Desktop/LM-FP/data/miRNA_disease.xlsx');
    [~,ld]=xlsread('C:/Users/AreJay/Desktop/LM-FP/data/lncRNA_disease.xlsx');
    L_in_ml = unique(ml(:,2));
    D_in_md  = unique(md(:,2));
